...
class TraCIKernelNetwork(BaseKernelNetwork):
    ...
    def generate_network(self, network, emission_path):
        """See parent class.
        ...
        cfg_name, random_num = self.generate_cfg(emission_path,
                                                 self.network.net_params,
                                                 self.network.traffic_lights,
                                                 self.network.routes,
                                                 self.network.template_vehicles)
    ...
    def generate_cfg(self, emission_path, net_params, traffic_lights, routes, vehicles):
        ...
        random_num = random.randint(1, 3)  # avoid rewrite between episodes
        ...
        cfg.append(
            _inputs(
                ...
                gui=self.guifn))
        t = E('time')
        t.append(E('begin', value=repr(19800)))
        cfg.append(t)
