...
from flow.envs.multiagent import UAVEnvIntelliLight
...
flow_params = dict(
    exp_tag='IntelliLight_ppo',

    env_name=UAVEnvIntelliLight,
    ...
    sim=SumoParams(
        ...
        emission_path="{}/output/IntelliLight_ppo".format(ABS_DIR)
    ),
